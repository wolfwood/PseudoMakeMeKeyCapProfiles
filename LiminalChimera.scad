...
MX = 1;
Null =2;
//// override Z-butt paramSecondaryDish == true
//lp_key = [
////     "base_sx", 18.5,
////     "base_sy", 18.5,
//     "base_sx", 17.65,
...
//difference(){
for(i = [0:2]){
  translate([0,-16*i,0])keycap(keyID =3*i, cutLen = 0, heightAdjust = 0, Stem = Choc,  Dish = true, visualizeDish = false, crossSection = crossBool, Sym = true, Rotation = 0, homeDot = false);
  translate([16,-16*i,0])keycap(keyID = 3*i+9, cutLen = 0, heightAdjust = 0,Stem = Choc,  Dish = true, visualizeDish = false, crossSection = crossBool, Sym = true, Rotation = 0);
  }
