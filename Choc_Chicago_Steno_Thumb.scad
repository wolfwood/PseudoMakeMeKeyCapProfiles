...
topthickness = 2.6; //2 for phat 3 for chicago
...
//  BotWid,  BotLen, TWDif,    TLDif, keyh, WSft, LSft  XSkew, YSkew, ZSkew, WEx, LEx, CapR0i, CapR0f,  CapR1i, CapR1f, CapREx,  StemEx
    ...
    [15.65,  26.4,    5.5, 	3.25,  4.9,  -.5,  0.0,      0,    0,      0,   2,   2,     .3,      2,      .3,    2.5,     2,       2], //Thumb 01.5
    [15.65,  35.8,   4.25, 	3.25,  4.9, -.25,  0.0,      0,    0,      0,   2,   3,     .3,      2,      .3,    2.5,     2,       2], //Thumb 02.0
    [15.65,  30.90,   5.5, 	3.25,  4.9,  -.5,  0.0,      0,    0,      0,   2,   2,     .3,      2,      .3,    2.5,     2,       2], //Thumb 01.75
    [17.2,  26.4,     5.5, 	3.25,  4.9,  -.5,  0.0,    -3,    -2,     -2,   2,   2,     .3,      2,      .3,    2.5,     2,       2], //Thumb 1.5
    [17.2,  26.4,     5.5, 	3.25,  4.9,  -.5,  0.0,      0,    0,      0,   2,   2,     .3,      2,      .3,    2.5,     2,       2], //Thumb 01.5
];
...
//FFwd1 FFwd2 FPit1 FPit2  DshDep DshHDif FArcIn FArcFn FArcEx     BFwd1 BFwd2 BPit1 BPit2  BArcIn BArcFn BArcEx FTani FTanf BTani BTanf TanEX PhiInit PhiFin
  ...
  [ 4.5,    4,    7,  -50,      7,    1.7,   11,    17,     2,      4.5,    4,    2,   -35,   11,    15,     2], //Chicago Steno R1
  [ 4.5,    4,    7,  -50,      7,    1.7,   11,    17,     2,      4.5,    4,    2,   -35,   11,    15,     2], //Chicago Steno R1
  [   5,  5.5,    0,  -40,      7,    1.7,   16,    18,     2,       5.5,  3.5,    5,   -50,   16,    18,     2,     5,   3.75,    2,    3.75,   2, 199, 210], //T0
  [  10,  4.5,    0,  -40,      7,    1.7,   16,    15,     2,        10,  3.5,    5,   -50,   16,    18,     2,     3,   3.75,    .75,    3.75,   2, 200, 210], //1.5u
  [  14.5, 4.5,   4,  -40,      7,    1.7,   16,    18,     2,      14.5,  4.5,    2,   -35,   16,    23,     2,     3,   3.75,    .75,    3.75,   2, 200, 210], //2.0u
  [ 12.25, 4.5,   0,  -40,      7,    1.7,   16,    15,     2,     12.25,  3.5,    5,   -50,   16,    18,     2,     3,   3.75,    .75,    3.75,   2, 200, 210], //1.75u
  [  10,  4.5,    0,  -40,      7,    1.7,   16,    15,     2,        10,  3.5,    5,   -50,   16,    18,     2,     3,   3.75,    .75,    3.75,   2, 200, 210], //1.5u
  [  10,  4.5,    0,  -40,      7,    1.7,   16,    15,     2,        10,  3.5,    5,   -50,   16,    18,     2,     3,   3.75,    .75,    3.75,   2, 200, 210], //1.5u
];
...
function StemTransform(t, keyID) =
  [
    ...
    pow(t/stemLayers, StemExponent(keyID))*(BottomLength(keyID)) + (1-pow(t/stemLayers, StemExponent(keyID)))*(stemLen - 2*slop)
  ];
...
module keycap(keyID = 0, cutLen = 0, visualizeDish = false, crossSection = false, Dish = true, SecondaryDish = false, Stem = false, StemRot = 0, homeDot = false, Stab = 0, Legends = false) {
  ...
  function BackDishArc(t)  =  pow((t)/(len(FrontPath)),BackArcExpo(keyID))*BackFinArc(keyID) + (1-pow(t/(len(BackPath)),BackArcExpo(keyID)))*BackInitArc(keyID);
